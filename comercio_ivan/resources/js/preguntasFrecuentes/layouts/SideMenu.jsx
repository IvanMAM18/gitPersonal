...
export default function SideMenu() {
    ...
    const handleButtonClick = (idPregunta, sideMenu) => {
        setSelectTitle(idPregunta);
        setSelectOption(sideMenu);
    };
    ...
    return (
        <>
            <div className="h-full">
                ...
                <br />
                <Main 
                    preguntaSelect={selectTitle === '' ? preguntasFrecuentes : preguntasFrecuentes[selectTitle]}
                    indexSelect={selectTitle}
                    selectSideMenu={selectOption}
                />
