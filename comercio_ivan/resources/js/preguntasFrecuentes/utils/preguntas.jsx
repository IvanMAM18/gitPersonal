export const preguntasFrecuentes = {
    ...
    sobreLicencia:{
        tile:'Sobre las Licencias',
        description:'Encuentra infromación sobre los trámites t requisitos de licencias.',
        1:{
