        ...
        preguntas:[
            {
                ...
                content: `
                    Ingresa a la página de <a href="https://tramites.lapaz.gob.mx/register"><b>registro de usuarios para el Portal de Trámites y Servicios en Línea</b></a>, selecciona la opción “REGÍSTRATE”, al ingresar va a necesitar:
            ...
            },
            {
                title: '¿Cómo cambiar el correo electrónico?', 
                    ...
                    de correo electrónico a la siguiente dirección: <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> donde deberá anexar:
                    <ul style="padding-left:4%">
            ...
            { 
                ...
                <ol>
                  <li>- Ingresar al <a href="https://tramites.lapaz.gob.mx/login"><b>Portal de Trámites y Servicios en Línea</b></a></li>
            ...
            { 
                ...
                H. Ayuntamiento de La Paz</strong> o mediante una solicitud a la siguiente dirección: <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> en donde deberá anexar:
                <ul style="padding-left:4%">
            ...
            { 
                ...
                sus trámites con un gestor, es necesario que el contribuyente solicite al correo <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> el 
                ...
                H. Ayuntamiento de La Paz</strong> o mandar correo a <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> solicitando más información al respecto.
                ` 
            },
            { 
                title: '¿Qué hago si no puedo acceder a mi cuenta porque la manejaba un gestor?', 
                content: `
                El contribuyente tiene que solicitar al correo <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a>
            ...
            { 
                ...
                content: `
                <ul>
                  <li>Ingresa a <a href="https://tramites.lapaz.gob.mx/login"><b>Portal de Trámites y Servicios en Línea</b></a>.</li>
            ...
            { 
                ...
                <ul>
                  ...
                  <li>Borra el historial o caché/cookies de tu dispositivo móvil u ordenador e ingresa al <a href="https://tramites.lapaz.gob.mx/login"><b>Portal de Trámites y Servicios en Línea</b></a>.</li>
                </ul>
                ` 
            }
        ]
    },
    {
        ...
        preguntas: [
            ...
            },
            {
                ...
                content: `
                <ol>
                    <li style="font-weight: bold;">Ingresa al <a href="https://tramites.lapaz.gob.mx/login"><b>Portal de Trámites y Servicios en Línea</b></a></li>
        ...
        preguntas: [
            {
                ...
                en la plataforma <a href="https://tramites.lapaz.gob.mx/"><b>Portal de Trámites y Servicios en Línea</b></a>, dentro de su cuenta, hay un apartado 
                ...
                <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> que se vincule la persona moral al ID del trámite. Los 
            ...
            },
            {
                ...
                H. Ayuntamiento de La Paz</strong> o por correo a 
                <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> que se 
            ...
            },
            {
                ...
                content: `Hay que solicitar en <strong>ventanilla de la Dirección de Comercio del 
                H. Ayuntamiento de La Paz</strong> o por correo a <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> que se 
            ...
            },
            {
                ...
                <a href="https://tramites.lapaz.gob.mx/register"><b>Portal de Trámites y Servicios en Línea</b></a> con su nombre, CURP y RFC, así como enviar por 
                correo a <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> la solicitud de traslado de ID del trámite a la 
            ...
            },
            {
                ...
                <a href="https://tramites.lapaz.gob.mx/login"><b>Portal de Trámites y Servicios en Línea</b></a>  con su nombre, CURP y RFC, así como enviar por 
                correo a <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> la solicitud de traslado de ID del trámite a la 
            ...
            },
            {
                ...
                documento de propiedad, se debe solicitar al correo <a href="mailto:info.comercio@lapaz.gob.mx"><b>info.comercio@lapaz.gob.mx</b></a> 
            ...
            },
            {
                ...
                <b>Portal de Trámites y Servicios en Línea</b></a>, en 
    ...
    },
    {
        ...
        preguntas: [
            ...
            },
            {
                ...
                <b>Reglamento de Imagen Urbana del Municipio de La Paz.</b></a>`
            },
            {
    ...
    },
    {
        ...
        preguntas: [
            ...
            },
            {
                ...
                content: `Ingrese a la <a href="http://www.proteccioncivil.gob.mx/work/models/sismos/Resource/37/1/images/gteipipc.pdf"><b>Guía Interna para
                la Elaboración del Programa Interno de Protección Civil.</b></a>`
            },
            {
                ...
                <b>Portal de Trámites y Servicios en Línea</b></a>
            ...
            },
            {
                ...
                <b>Portal de Trámites y Servicios en Línea</b></a>, en la 
        ...
        preguntas: [
            {
                ...
                <b>serviciospublicos@lapaz.gob.mx</b></a> o acudir directamente a las oficinas de la <strong>Dirección 
