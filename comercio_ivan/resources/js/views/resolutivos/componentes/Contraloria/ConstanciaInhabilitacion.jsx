...
export default function ConstanciaInhabilitacion({ tramite }) {
    ...
    const onFormComplete = (values) => {
        const valuesData = jsonToFormData({
            ...
            observaciones: "ConstanciaInhabilitacion",
        });
    ...
    return (
        <Form
            name="CONSTANCIA DE NO INHABILITACIÓN PARA TRABAJAR EN LA ADMINISTRACIÓN PÚBLICA MUNICIPALCERTIFICACIÓN DE MEDIDAS DE SEGURIDAD"
