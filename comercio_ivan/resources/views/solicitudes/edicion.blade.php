...
@section('content')
  ...
  <form action= "{{ url('/solicitudes/'.$datos->folio) }}" method="post" id="actualizasare">
    @csrf
        ...
        <input id="txtidpuc" name="txtidpuc" type="hidden">    
          ...
          <div class="container p-3 my-3 border">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input readonly type="date" id="txtfecha" name="txtfecha" value="{{isset($datos->fecha)?date('Y-m-d',strtotime($datos->fecha)):date('Y-m-d')}}">
                  </div>    
                ...
                <div class="form-group col-md-4">  
                  ...
                  @if($datos->id_persona == 1)         
                    <input type="radio" id="optpersonafisica" name="opttipopersona" value="1" checked> Fisica
                    <input type="radio" id="optpersonamoral" name="opttipopersona" value="2"> Moral
                  @endif

                  @if($datos->id_persona == 2)           
                    <input type="radio" id="optpersonafisica" name="opttipopersona" value="1"> Fisica
                    <input type="radio" id="optpersonamoral" name="opttipopersona" value="2" checked> Moral           
                  @endif
          ...
          <div class="container p-3 my-3 border">
              ...
              <div class="form-group row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="date" id="txtfechaoperaciones" name="txtfechaoperaciones" value="{{isset($datos->inop_e)?date('Y-m-d',strtotime($datos->inop_e)):date('Y-m-d')}}">
                  </div>
           ...
           <input class="form-control" type="hidden" id="txtlng" name="txtlng" value="{{isset($datos->lng)?$datos->lng :0}}"> 
            ...
            <div class="form-group row" id="map" style="height:600px; width: 1000px;" >
            </div>
          
          </div> 

          <div class="container p-3 my-3 border">
            <button class="btn btn-primary" onclick="return confirm('Desea actualizar la información?')" type="submit" form="actualizasare" >
                Actualizar
            </button>  
          </div>   
...
let map;
var latitud = {{isset($datos->lat)?$datos->lat :24.14266563975116}};
var longitud = {{isset($datos->lng)?$datos->lng :-110.30185489206237}};
