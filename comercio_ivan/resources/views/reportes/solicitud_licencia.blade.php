    ...
    <tr>
      ...
      <td style ="border:none">
        <P style = "text-align: center; font-size:10; margin: 0; font-weight:bold">
          FORMATO SOLICITUD DE APERTURA RÁPIDA DE EMPRESAS 
        </P>
...
<table style = "border:none">
    ...
    <tr style = "line-height:1.2">
      <td style = "font-size: 7.5; border:none">CLAVE DEL CATÁLOGO DE GIROS COMERCIALES:</td>
        ...
        <td style = "text-align: center;font-size:7.5; border:none"> 
          <div style=" background-color: #f8f8f8; border: 1px solid; border-radius: 10px 10px 10px 10px">  
            {{ isset($datospdf->giro)?$datospdf->giro:'' }}
          </div>  
        </td>
    ...
    <tr style = "line-height:1.2">     
        ...
        <td style = "font-size: 7.5;border:none">FOLIO DEL CATÁLOGO:</td>
        <td style = "text-align: center;font-size:7.5;border:none">
          <div style=" background-color: #f8f8f8; border: 1px solid; border-radius: 10px 10px 10px 10px"> 
          @if($datospdf->id_tramite == 4)            
            {{ isset($tipnegocio->scian)?$tipnegocio->scian:'' }}
                @else
                {{ isset($tipnegocio->codigo)?$tipnegocio->codigo:'' }}
            @endif      
          </div>
        </td>
    </tr> 
...
<thead>
    <tr>
      <th width="33%" style = "border:none;font-size:7">SARE</th>
  ...
  <tbody>
    <tr>
        <td width="1" style="border:none">
            <P style = "text-align: justify ; font-size:7; margin: 0; line-height: normal">
              1.-Formato Único de Apertura (debidamente llenado)<br>
              2.-Copia de identificación oficial<br>
              3.-Copia legal del local<br>
                (contrato de arrendamiento o escrituras)<br>
              4.-Copia de pago de proteccion civil<br>
                (se realiza durante el tramite)<br>
            </P>   
        </td>
    
        <td width="1" style="border:none">
          <P style = "text-align: justify ; font-size:7; margin: 0; line-height: normal ">
            1.-Llenar formato de solicitud de refrendo<br>
            2.-Licencia de funcionamiento original<br>
            3.-Identificacion oficial<br>
            4.-Dictámen de COEPRIS (en caso de que el giro<br> 
            incluya alimentos y bebidas)
          </P>     
        </td>
